...
const char* ssid_sta = "b";     // your network SSID (name)
const char* pass_sta = "password";     // your network password (use for WPA, or use as key for WEP)
...
const String apiKey = "Y5YC44ZBHBX8QSL8";  //API key for the Thingspeak ThingHTTP already configured
